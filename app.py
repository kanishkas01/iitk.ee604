...
✅ What’s added (without breaking anything):

Original image display

Colorized depth map

Histogram + Gaussian smoothed plot

Derivative (DoG) + minima plot

Individual binary masks per object

Final annotated result

Would you like me to also add checkboxes to optionally hide intermediate outputs (for faster runtime later)?
